...
export class ClassDetailComponent {
	...
	async ngOnInit() {
		...
		this._route.params.subscribe((params: ParamMap) => {
			...
			this.selectedAcademicLevelId = params['academicLevelId'];
			this.selectedClassNameId = params['classNameId'];

			if (this.selectedAcademicYearId > 0 && this.selectedAcademicLevelId > 0 && this.selectedClassNameId > 0) {
