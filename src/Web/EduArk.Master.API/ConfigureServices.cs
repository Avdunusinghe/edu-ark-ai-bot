...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        public static IServiceCollection AddEduArkMasterWebAPIServices(this IServiceCollection services, IConfiguration configuration)
        {
