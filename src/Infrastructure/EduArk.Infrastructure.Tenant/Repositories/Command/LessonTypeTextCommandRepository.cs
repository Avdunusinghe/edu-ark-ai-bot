...
{
    public class LessonTypeTextCommandRepository : CommandRepository<LessonTypeText>, ILessonTypeTextCommandRepository
    {
        public LessonTypeTextCommandRepository(TenantDbContext context) : base(context) 
        {
