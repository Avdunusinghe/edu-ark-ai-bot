...
{
    public class ExamMarkCommandRepository : CommandRepository<ExamMark>, IExamMarkCommandRepository
    {
        public ExamMarkCommandRepository(TenantDbContext context) : base(context)
        {
