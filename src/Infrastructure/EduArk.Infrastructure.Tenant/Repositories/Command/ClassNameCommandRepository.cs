...
{
    public class ClassNameCommandRepository : CommandRepository<ClassName>, IClassNameCommandRepository
    {
        public ClassNameCommandRepository(TenantDbContext context) : base(context)
        {
