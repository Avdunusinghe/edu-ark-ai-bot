...
{
    public class SubjectTeacherCommandRepository : CommandRepository<SubjectTeacher>, ISubjectTeacherCommandRepository
    {
        public SubjectTeacherCommandRepository(TenantDbContext context) : base(context)
        {
