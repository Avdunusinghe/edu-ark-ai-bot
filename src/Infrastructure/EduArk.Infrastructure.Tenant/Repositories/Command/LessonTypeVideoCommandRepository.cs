...
{
    public class LessonTypeVideoCommandRepository : CommandRepository<LessonTypeVideo>, ILessonTypeVideoCommandRepository
    {
        public LessonTypeVideoCommandRepository(TenantDbContext context) : base(context)
        {
