...
{
    public class AssessmentCommandRepository : CommandRepository<Assessment>, IAssessmentCommandRepository
    {
        public AssessmentCommandRepository(TenantDbContext context) : base(context)
        {
