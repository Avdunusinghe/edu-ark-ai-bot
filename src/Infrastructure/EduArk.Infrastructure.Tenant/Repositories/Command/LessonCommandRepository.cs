...
{
    public class LessonCommandRepository : CommandRepository<Lesson>, ILessonCommandRepository 
    {
        public LessonCommandRepository(TenantDbContext context) : base(context) 
        { 
