...
{
    public class ExamMarkQueryRepository : QueryRepository<ExamMark>, IExamMarkQueryRepository
    {
        public ExamMarkQueryRepository(TenantDbContext context) : base(context)
        {
