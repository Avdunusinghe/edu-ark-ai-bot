...
namespace EduArk.Infrastructure.Tenant.Migrations
{
    ...
    [Migration("20231018130200_Edu_Ark_Development_85_2")]
    partial class Edu_Ark_Development_85_2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduArk.Domain.Entities.Tenant.ExamMark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ExamMark", (string)null);
                });
            ...
            modelBuilder.Entity("EduArk.Domain.Entities.Tenant.Student", b =>
                {
                    ...
                    b.Property<bool>("ClassAttendance")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<int>("ConfidentAcademicPerformance")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
                    ...
                    b.Property<bool>("PersonalMotivation")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("PriorKnowledgeOfTheSubject")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("StudyEnvironment")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
                    ...
                    b.Property<bool>("TeacherInstructorQuality")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("TimeManagementSkills")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("EduArk.Domain.Entities.Tenant.ExamMark", b =>
                {
                    ...
                    b.HasOne("EduArk.Domain.Entities.Tenant.Exam", "Exam")
                        .WithMany("ExamMarks")
