...
{
    /// <inheritdoc />
    public partial class EduArkTenant00001 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserConfirmationSecutiryCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PasswordResetSecurityToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
